...
--
-- Host: localhost
-- Generation Time: Nov 17, 2024 at 09:03 PM
...
CREATE TABLE `downloads` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) DEFAULT NULL,
  `d_file` varchar(191) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(63, '2022_03_12_153514_add_fielsd_to_staffs', 26),
(64, '2022_03_12_205106_add_new_field_to_staff', 26),
(65, '2022_03_12_205633_create_units_hods_table', 26),
(66, '2024_10_21_103920_create_settings_table', 26),
(67, '2024_10_21_104550_add_field_to_users', 27);
...
CREATE TABLE `nav_dropdowns` (
  ...
  `status` int(11) NOT NULL DEFAULT 1,
  `external_link` varchar(220) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `settings` (`id`, `logo`, `site_name`, `site_phone`, `site_email`, `site_copyright`, `facebook`, `instagram`, `twitter`, `linkedIn`, `pinterest`, `address`, `about`, `footer_menu`, `created_at`, `updated_at`) VALUES
(1, 'logo.png', 'Yabatechdsdsd', '+234-7037431055', 'registrar@yabatech.edu.ng', 'Yaba College Of Technology . All rights reserved.\n                Created by', NULL, NULL, 'https://twitter.com/landiquire', NULL, NULL, NULL, NULL, NULL, NULL, '2024-10-21 19:24:49');
...
CREATE TABLE `sport_complexes` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `headine` varchar(191) DEFAULT NULL,
  `image` varchar(191) DEFAULT NULL,
  `gallery` text DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
CREATE TABLE `staff` (
  ...
  `departments` varchar(191) DEFAULT NULL,
  `designation` varchar(191) DEFAULT NULL,
  ...
  `dappt` varchar(191) DEFAULT NULL,
  `dprom` varchar(191) DEFAULT NULL,
...
INSERT INTO `staff` (`id`, `name`, `image`, `email`, `department_id`, `category_id`, `departments`, `designation`, `qualification`, `Publications`, `research_areas`, `created_at`, `updated_at`, `cv`, `bio`, `school_id`, `dob`, `staff_no`, `dappt`, `dprom`, `gradelevel`, `origin`, `lga`, `signature`, `phone`, `mobile`, `sex`, `unit`, `title`, `birthday`, `personal_email`, `unit_id`) VALUES
(1, 'Nanre Charles Benedi', '0b76f89fbdff7fd262fdc6edcce94b79.jpg', 'nanre.charlse@yabatech.edu.n', 1, 3, 'efkgdjdf', NULL, NULL, NULL, NULL, '2021-09-13 23:07:27', '2021-11-08 00:41:21', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(2, 'Olaifa Oluwafemi Adeyinka', 'cf8ea4ed1917589d348c2c657e99e62f.jpg', NULL, 2, 2, 'CHIEF DATA PROCESSING ASSISTANT', 'CHIEF DATA PROCESSING ASSISTANT', NULL, NULL, NULL, '2021-09-13 23:07:27', '2021-11-08 00:43:55', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(3, 'Olatunji Folashade Funmilola', 'prof.jpg', NULL, 2, 2, 'Office Of The Dean', 'CHIEF CLERICAL OFFICER', 'Bachelor of Science (Demography & Social Statistics)', NULL, NULL, '2021-09-13 23:07:27', '2021-09-13 23:07:27', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(4, 'Adesokan Oluwakemi Adepero', 'prof.jpg', 'oluwakemi.adesokan@yabatech.edu.ng', 2, 2, 'Office Of The Dean', 'SENIOR CONFIDENTIAL SECRETARY', 'NATIONAL DIPLOMA (Office Technology Management), HIGHER NATIONAL DIPLOMA (Office Technology Management)', NULL, NULL, '2021-09-13 23:07:27', '2021-09-13 23:07:27', NULL, NULL, 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
...
(6, 'Alli Hajarat Abdul, Mrs.', 'ali.jpg', 'hajarat.ali@yabatech.edu.ng', 2, 2, 'Office Of The Dean', 'CHIEF DATA PROCESSING ASSISTANT', 'NATIONAL DIPLOMA (Business Administration), HIGHER NATIONAL DIPLOMA (Business Administration)', NULL, NULL, '2021-09-13 23:07:27', '2021-09-13 23:07:27', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'michael kachi', '6e5c6686cf044af596dfe08d92d7b45e.png', 'michaelkachi@yabatech.edu.ng', 1, 1, NULL, NULL, 'HND computer science', NULL, NULL, '2021-09-18 11:46:10', '2021-09-18 11:46:10', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(8, 'michael kachi', '0099fdac00154d0decf3c58bfe8e0d19.png', NULL, 1, 1, NULL, NULL, 'HND computer science', NULL, NULL, '2021-09-18 11:46:37', '2021-09-18 11:46:37', NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `tetfund_books` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `name` varchar(191) DEFAULT NULL,
  `dpt` varchar(191) DEFAULT NULL,
  `book_title` varchar(191) DEFAULT NULL,
...
CREATE TABLE `tetfund_research` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `lead_research` varchar(191) DEFAULT NULL,
  `dpt` varchar(191) DEFAULT NULL,
  `title` varchar(191) DEFAULT NULL,
...
CREATE TABLE `tetfund_trainings` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `funding_date` varchar(191) DEFAULT NULL,
  `name` varchar(191) DEFAULT NULL,
  `sex` varchar(191) DEFAULT NULL,
  `programme` varchar(191) DEFAULT NULL,
  `university` varchar(191) DEFAULT NULL,
  `country` varchar(191) DEFAULT NULL,
  `start_year` varchar(191) DEFAULT NULL,
  `end_year` varchar(191) DEFAULT NULL,
...
--
-- Table structure for table `units_hods`
--

CREATE TABLE `units_hods` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `staff_id` int(11) DEFAULT NULL,
  `unit_id` int(11) DEFAULT NULL,
...
CREATE TABLE `users` (
  ...
  `last_login` varchar(191) DEFAULT NULL,
...
INSERT INTO `users` (`id`, `name`, `email`, `email_verified_at`, `password`, `image`, `remember_token`, `created_at`, `updated_at`, `deleted_at`, `login_ip`, `last_login`, `otp`, `is_verified`) VALUES
(1, 'Michael Kachi', 'mikkynoble@gmail.com', NULL, '$2y$10$LameUIJ5ZQSb7IXYBgLaKuiDU4eqGsWZrQ3qlA4DrBboFWAhFTKPe', 'image.jpg', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
(7, 'yct adminasas', 'wale.shogade@yabatech.edu.ng', NULL, '$2y$10$C/QSjrLJN5YGxPzgbUHufeGtR/b6JOTHQcaCjC5jXER1OjsvZ5aFy', NULL, NULL, '2024-10-21 14:53:03', '2024-10-21 19:25:29', NULL, NULL, '2024-10-21 17:37:14', '564850', 1);
...
--
-- Indexes for table `units_hods`
--
ALTER TABLE `units_hods`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `units_hods`
--
ALTER TABLE `units_hods`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
