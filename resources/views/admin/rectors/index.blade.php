                     ...
                     <div class="card">
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                <h6 class="card-title">Administration</h6>
                                <div>
                                    <a href="{{route('admin.staff.list')}}" class="mr-3">
                                        ...
                                        @foreach ($rectors as  $sp)
                                            ...
                                            <td>{{$sp->id}}</td>
                                                ...
                                                <td>
                                                 ...
                                                 <td>
                                                    <a href="#">{!!substr($sp->about,0,50)!!}</a>
                                                </td> 
                                                <td>
                                                    <a href="#">{!!substr($sp->message, 0,50)!!}</a>
                                                </td>
                                                <td>
                                                    <a href="#"><img src="{{asset('/assets/img/site/'.$sp->image)}}" width="50px" height="50px"></a> 
                                                </td> 
                                                <td class="text-right">
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a href="{{route('administration.edit', encrypt($sp->id))}}" class="dropdown-item">Edit</a>
                                                            @if($sp->is_active != 2)
