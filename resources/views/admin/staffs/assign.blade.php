...
@section('content')
 <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
              <form method="post" enctype="multipart/form-data" action="{{route('staff.assignPost', encrypt($staff->id))}}">
              @csrf
              <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row">
                              <div class="col-md-12">
                                         <div class="form-group">
                                          ...
                                          <option> Select Administrative post </option>
                                          @foreach($role as $roles)
                                           <option value="{{$roles->link}}"> @php 
                                              // $rol = explode('.',$roles->link);
                                               echo $roles->name;
                                            @endphp </option>
                                           @endforeach
                                           </select>
                              ...
                              <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                      ...
                                      <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <small id="emailHelp" class="form-text text-muted">Staff publication - post publication links
                                            </small>
                                            @error('publication')
                                            <span class="invalid-feedback"> <small> * </small> </span>
                                            @enderror
                                  ...
                                  <div class="custom-file">
                                           ...
                                           <div class="col-md-12">
                                        <div class="form-group">
                                                   <textarea name="bio">{{$staff->bio}}</textarea>
                                                        <script>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-4">
                        <div class="p-5">
                             <button type="submit" class="btn btn-primary w-100 p-3">Update Staff Role</button>
                           </div>
                           </div>
                           </div>
                        </div>
