...
<head>
    ...
    <meta name="description" content="Yaba College of Technology Lagos Nigeria the first institution and best polytechnic in Nigeria"/>
    <meta name="author" content="Yabatech"/>
    <meta name="keywords" content="Yabatech, Polytechnic, NBTE, Yct, College, Technology"/>
    <meta name="author" content="Yabatech"/>
    <meta name="copyright" content="Yaba College of Technology Lagos Nigeria"/>
    <meta http-equiv="content-type" content="text/html; charset=utf-8"/>
    <meta name="description" content="Yaba College of Technology, the first institution and best polytechnic in Nigeria"/>
    <meta name="rating" content="general"/>
    <meta name="robots" content="all,follow"/>
    <meta name="googlebot" content="index,follow"/>
    <meta property="og:url" content="{{$settings->facebook}}"/>
    <meta property="og:type" content="website"/>
    <meta property="og:title" content="Yaba College of Technology Lagos Nigeria"/>
    <meta property="og:description" content="Yaba College of Technology Lagos Nigeria the first institution and best polytechnic in Nigeria"/>
    <meta property="og:image" content="./assets/img/favicon/favicon-96x96.png"/>
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no"/>
    <link rel="apple-touch-icon"
        sizes="57x57" href="{{ asset('./assets/img/favicon/apple-icon-57x57.png') }}"/>
...
@include('users.includes.main-css')
    @yield('styles')
</head>
<body>
...
<!-- Scripts-->
@include('users.includes.main-js')
@stack('scripts')
@yield('script')
</body>
</html>
