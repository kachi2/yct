                ...
                <div class="col-12">
                    <div class="mb-5">
                        ...
                        <p>
                            ...
                            magna aliquam erat volut pat. Ut wisi enim ad minim veniam, quis
                            nostrud exerci tation ullamcorper suscipit lobortis nisl ut
                            aliquip ex ea commodo consequat. Claritas est etiam processus
                            dynamicus, qui sequi tur mutationem consuetudium lectorum.
                            suscipit lobortis nisl ut aliquip ex ea commodo consequat.
                            Claritas est etiam processus dynamicus, qui sequitur mutationem
                            consuetudium lectorum.suscipit lobortis nisl ut aliquip ex ea
                            commodo consequat.
                        </p>
                    </div>
                    <!-- END mb-5 -->
                    ...
                    <div class="mb-5">
                        ...
                        <ul>
                            <li class="mb-2">
                                We may collect personal information directly when you provide
                                it to us, automatically as you navigate through the Sites or
                                through other people when you use services associated with the
                                Sites.
                            </li>
                            <li class="mb-2">
                                If you choose not to provide personal information, we may not
                                be able to provide you with our services and you may not be
                                able to carry out tran sactions or access the full range of
                                features available through our Sites.
                            </li>
                        </ul>
                    </div>
                    <!-- END mb-5 -->
                    ...
                    <div class="mb-5">
                        <h2 class="mb-4">How We Collect Personal Information</h2>
                        <ul>
                            <li class="mb-2">
                            ...
                            <li class="mb-2">
                                Other people where we are authorised or required by law to do
                                so.
                            </li>
                            <li class="mb-2">
                    ...
                    <div class="mb-5">
                        <h2 class="mb-4">When we need to update this policy</h2>
                        <p>
                            Nam liber tempor cum soluta nobis eleifend option congue is
                            nihil imper per tem por legere me that doming vulputate the
                            molestie Lorem ipsum dolor sit amet, consectetuer adipiscing
                    ...
                    <div class="mb-5">
                        <h2 class="mb-4">How can you contact us?</h2>
                        <p>
                            Nam liber tempor cum soluta nobis eleifend option congue is
                            nihil imper per tem por legere me that doming vulputate the
                            molestie Lorem ipsum dolor sit amet, consectetuer adipiscing
                    ...
                    <div class="mb-5">
                        ...
                        <p>
                            ...
                            <a href="mailto:support@yabatech.com" class="text-primary"
                            >support@yabatech.com</a
                            >
                        </p>
                        <ul>
                            <li class="mb-2">
