  ...
  var ECHOCOMPONENTS = {
    ...
    fancyBox: function () {
      if ($("[data-fancybox]").exists()) {
        loadScript(
          $assetsPath + "/fancybox-master/dist/jquery.fancybox.min.js",
          function () {
    ...
    owlCarousel: function () {
      if ($(".owl-carousel").exists()) {
        loadScript(
          $assetsPath + "/owl.carousel/dist/owl.carousel.min.js",
          function () {
      ...
      if ($(".ec-select").exists()) {
        loadScript($assetsPath + "/chosen/chosen.jquery.min.js", function () {
          ...
          $(".ec-select").each(function () {
            var $this = $(this),
              $disable_search = $this.data("disable-search")
                ? $this.data("disable-search")
                : false,
              $disable_search_threshold = $this.data("disable-search-threshold")
                ? $this.data("disable-search-threshold")
                : 6,
              $max_selected_options = $this.data("max-selected-options")
                ? $this.data("max-selected-options")
                : "Infinity",
              $select_width = $this.data("select-width")
                ? $this.data("select-width")
                : "100%",
              $group_search = $this.data("group-search")
                ? $this.data("group-search")
                : false,
              $select_btn_class = $this.data("btn-classes")
                ? $this.data("btn-classes")
                : null,
              $select_placeholder = $this.data("placeholder-text")
