...
class NavDropdownSeeder extends Seeder
{
    ...
    public function run()
    {
        $navDropdownItems = [
            ...
            ['name' => 'Yabatech Consult Limited', 'link'=>'enterprise.consult', 'nav_list_id' => 17],
            ['name' => 'Skills Acquisition', 'link'=>'enterprise.acquisition', 'nav_list_id' => 17],
            ['name' => 'Facility Management', 'link'=>'enterprise.facility', 'nav_list_id' => 17],
            ['name' => 'Asset Managment', 'link'=>'enterprise.asset', 'nav_list_id' => 17],
            ['name' => 'Seminars & Conference', 'link'=>'enterprise.seminars', 'nav_list_id' => 17],
            ['name' => 'Advert Services', 'link'=>'enterprise.adverts', 'nav_list_id' => 17],
            ['name' => 'Consultancy Services', 'link'=>'enterprise.services', 'nav_list_id' => 17],
            ['name' => 'Products', 'link'=>'enterprise.products', 'nav_list_id' => 17],
        ];
